...
(function() {
	...
	AbstractChosen = (function() {
		...
		AbstractChosen.prototype.container_width = function() {
			...
			width = window.getComputedStyle != null ? parseFloat(window.getComputedStyle(this.form_field).getPropertyValue(
					'width'))
					: (typeof jQuery !== "undefined" && jQuery !== null) && (this.form_field_jq != null) ? this.form_field_jq
							.outerWidth() : this.form_field.getWidth();
			return width + "px";
		};
...
(function() {
	var $, Chosen, root, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
	...
	Chosen = (function(_super) {
		...
		Chosen.prototype.set_up_html = function() {
			...
			if (this.is_multiple) {
				...
				this.container
						.html('<a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1"><span>'
								+ this.default_text
				...
				if (!((evt != null) && ($(evt.target)).hasClass("search-choice-close"))) {
					if (!this.active_field) {
						...
						this.results_show();
							...
							&& (($(evt.target)[0] === this.selected_item[0]) || $(evt.target).parents("a.chzn-single").length)) {
						evt.preventDefault();
						this.results_toggle();
					}
					return this.activate_field();
		...
		Chosen.prototype.choice_build = function(item) {
			...
			this.choices += 1;
			if (item.disabled) {
				html = '<li class="search-choice search-choice-disabled" id="' + choice_id + '"><span>' + item.html
						+ '</span></li>';
			} else {
				html = '<li class="search-choice" id="' + choice_id + '"><span>' + item.html
						+ '</span><a href="javascript:void(0)" class="search-choice-close" rel="' + item.array_index
						+ '"></a></li>';
			}
		...
		Chosen.prototype.winnow_results = function() {
			...
			results = 0;
			searchText = this.search_field.val() === this.default_text ? "" : $('<div/>').text($.trim(this.search_field.val()))
					.html();
					...
					if (option.group) {
						...
						if (found) {
							if (searchText.length) {
								...
								text = option.html.substr(0, startpos + searchText.length) + '</em>'
